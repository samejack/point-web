...
class Utility_String
{
     ...
     * @param boolean $humanized 人性化(避免容易識別錯誤字元)
     * @return string
     */
    public static function makePassword($length = 12, $humanized = true)
    {
        // make directory
        if ($humanized) {
    ...
    /**
     * Remove Non-Chinese and Half Char
     *
     * @param String $text
     * @return String
     */
    public static function removeNonChineseAndHalf($text)
    {
        preg_match_all('/[\x{4e00}-\x{9fa5}a-zA-Z0-9]/u', $text, $matches);
     ...
     * @return string
     */
    public static function normalizeCode128(string $text)
    {
        // 1. 轉成 ASCII
        $text = iconv('UTF-8', 'ASCII//TRANSLIT//IGNORE', $text);

        // 2. 移除所有非 Code128 可用字元
